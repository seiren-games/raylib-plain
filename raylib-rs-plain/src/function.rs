/* automatically generated by raylib-rs-plain */
...
pub fn init_window(width: c_int, height: c_int, title: *const c_char) {
    unsafe { rl::InitWindow(width, height, title) };
}
...
pub fn set_window_title(title: *const c_char) {
    unsafe { rl::SetWindowTitle(title) };
}
...
pub fn set_clipboard_text(text: *const c_char) {
    unsafe { rl::SetClipboardText(text) };
}
...
pub fn load_shader(vs_file_name: *const c_char, fs_file_name: *const c_char) -> Shader {
    return unsafe { rl::LoadShader(vs_file_name, fs_file_name) };
}

/** Load shader from code strings and bind default locations */
pub fn load_shader_from_memory(vs_code: *const c_char, fs_code: *const c_char) -> Shader {
    return unsafe { rl::LoadShaderFromMemory(vs_code, fs_code) };
}

/** Get shader uniform location */
pub fn get_shader_location(shader: Shader, uniform_name: *const c_char) -> c_int {
    return unsafe { rl::GetShaderLocation(shader, uniform_name) };
}

/** Get shader attribute location */
pub fn get_shader_location_attrib(shader: Shader, attrib_name: *const c_char) -> c_int {
    return unsafe { rl::GetShaderLocationAttrib(shader, attrib_name) };
}
...
pub fn take_screenshot(file_name: *const c_char) {
    unsafe { rl::TakeScreenshot(file_name) };
}
...
pub fn trace_log(log_level: c_int, text: *const c_char) {
    unsafe { rl::TraceLog(log_level, text) };
}
...
pub fn mem_alloc(size: c_int) -> *mut c_void {
    return unsafe { rl::MemAlloc(size) };
}

/** Internal memory reallocator */
pub fn mem_realloc(ptr: *mut c_void, size: c_int) -> *mut c_void {
...
pub fn load_file_data(file_name: *const c_char, bytes_read: *mut c_uint) -> *mut c_uchar {
    return unsafe { rl::LoadFileData(file_name, bytes_read) };
}
...
pub fn save_file_data(file_name: *const c_char, data: *mut c_void, bytes_to_write: c_uint) -> bool {
    return unsafe { rl::SaveFileData(file_name, data, bytes_to_write) };
}

/** Export data to code (.h), returns true on success */
pub fn export_data_as_code(data: *const c_char, size: c_uint, file_name: *const c_char) -> bool {
    return unsafe { rl::ExportDataAsCode(data, size, file_name) };
}

/** Load text data from file (read), returns a '\0' terminated string */
pub fn load_file_text(file_name: *const c_char) -> *mut c_char {
    return unsafe { rl::LoadFileText(file_name) };
}
...
pub fn save_file_text(file_name: *const c_char, text: *mut c_char) -> bool {
    return unsafe { rl::SaveFileText(file_name, text) };
}

/** Check if file exists */
pub fn file_exists(file_name: *const c_char) -> bool {
    return unsafe { rl::FileExists(file_name) };
}

/** Check if a directory path exists */
pub fn directory_exists(dir_path: *const c_char) -> bool {
    return unsafe { rl::DirectoryExists(dir_path) };
}

/** Check file extension (including point: .png, .wav) */
pub fn is_file_extension(file_name: *const c_char, ext: *const c_char) -> bool {
    return unsafe { rl::IsFileExtension(file_name, ext) };
}

/** Get file length in bytes (NOTE: GetFileSize() conflicts with windows.h) */
pub fn get_file_length(file_name: *const c_char) -> c_int {
    return unsafe { rl::GetFileLength(file_name) };
}

/** Get pointer to extension for a filename string (includes dot: '.png') */
pub fn get_file_extension(file_name: *const c_char) -> *const c_char {
    return unsafe { rl::GetFileExtension(file_name) };
}

/** Get pointer to filename for a path string */
pub fn get_file_name(file_path: *const c_char) -> *const c_char {
    return unsafe { rl::GetFileName(file_path) };
}

/** Get filename string without extension (uses static string) */
pub fn get_file_name_without_ext(file_path: *const c_char) -> *const c_char {
    return unsafe { rl::GetFileNameWithoutExt(file_path) };
}

/** Get full path for a given fileName with path (uses static string) */
pub fn get_directory_path(file_path: *const c_char) -> *const c_char {
    return unsafe { rl::GetDirectoryPath(file_path) };
}

/** Get previous directory path for a given path (uses static string) */
pub fn get_prev_directory_path(dir_path: *const c_char) -> *const c_char {
    return unsafe { rl::GetPrevDirectoryPath(dir_path) };
}
...
pub fn change_directory(dir: *const c_char) -> bool {
    return unsafe { rl::ChangeDirectory(dir) };
}

/** Check if a given path is a file or a directory */
pub fn is_path_file(path: *const c_char) -> bool {
    return unsafe { rl::IsPathFile(path) };
}

/** Load directory filepaths */
pub fn load_directory_files(dir_path: *const c_char) -> FilePathList {
    return unsafe { rl::LoadDirectoryFiles(dir_path) };
}
...
pub fn load_directory_files_ex(
    ...
    return unsafe { rl::LoadDirectoryFilesEx(base_path, filter, scan_subdirs) };
}
...
pub fn get_file_mod_time(file_name: *const c_char) -> c_long {
    return unsafe { rl::GetFileModTime(file_name) };
}
...
pub fn set_gamepad_mappings(mappings: *const c_char) -> c_int {
    return unsafe { rl::SetGamepadMappings(mappings) };
}
...
pub fn is_gesture_detected(gesture: c_int) -> bool {
...
pub fn set_camera_mode(camera: Camera, mode: c_int) {
    unsafe { rl::SetCameraMode(camera, mode) };
}

/** Update camera position for selected mode */
pub fn update_camera(camera: *mut Camera) {
    unsafe { rl::UpdateCamera(camera) };
}

/** Set camera pan key to combine with mouse movement (free camera) */
pub fn set_camera_pan_control(key_pan: c_int) {
    unsafe { rl::SetCameraPanControl(key_pan) };
}

/** Set camera alt key to combine with mouse movement (free camera) */
pub fn set_camera_alt_control(key_alt: c_int) {
    unsafe { rl::SetCameraAltControl(key_alt) };
}

/** Set camera smooth zoom key to combine with mouse (free camera) */
pub fn set_camera_smooth_zoom_control(key_smooth_zoom: c_int) {
    unsafe { rl::SetCameraSmoothZoomControl(key_smooth_zoom) };
}
...
pub fn set_camera_move_controls(
    ...
    unsafe {
        rl::SetCameraMoveControls(key_front, key_back, key_right, key_left, key_up, key_down)
    };
}
...
pub fn draw_line_bezier_quad(
    ...
    unsafe { rl::DrawLineBezierQuad(start_pos, end_pos, control_pos, thick, color) };
}

/** Draw line using cubic bezier curves with 2 control points */
pub fn draw_line_bezier_cubic(
    start_pos: Vector2,
    end_pos: Vector2,
...
pub fn load_image(file_name: *const c_char) -> Image {
    return unsafe { rl::LoadImage(file_name) };
}
...
pub fn load_image_raw(
    ...
    return unsafe { rl::LoadImageRaw(file_name, width, height, format, header_size) };
}

/** Load image sequence from file (frames appended to image.data) */
pub fn load_image_anim(file_name: *const c_char, frames: *mut c_int) -> Image {
    return unsafe { rl::LoadImageAnim(file_name, frames) };
}
...
pub fn load_image_from_memory(
    ...
    return unsafe { rl::LoadImageFromMemory(file_type, file_data, data_size) };
}
...
pub fn export_image(image: Image, file_name: *const c_char) -> bool {
    return unsafe { rl::ExportImage(image, file_name) };
}

/** Export image as code file defining an array of bytes, returns true on success */
pub fn export_image_as_code(image: Image, file_name: *const c_char) -> bool {
    return unsafe { rl::ExportImageAsCode(image, file_name) };
}
...
pub fn gen_image_gradient_v(width: c_int, height: c_int, top: Color, bottom: Color) -> Image {
    return unsafe { rl::GenImageGradientV(width, height, top, bottom) };
}

/** Generate image: horizontal gradient */
pub fn gen_image_gradient_h(width: c_int, height: c_int, left: Color, right: Color) -> Image {
    return unsafe { rl::GenImageGradientH(width, height, left, right) };
}
...
pub fn image_text(text: *const c_char, font_size: c_int, color: Color) -> Image {
    return unsafe { rl::ImageText(text, font_size, color) };
}
...
pub fn image_text_ex(
    ...
    return unsafe { rl::ImageTextEx(font, text, font_size, spacing, tint) };
}
...
pub fn image_draw_text(
    ...
    unsafe { rl::ImageDrawText(dst, text, pos_x, pos_y, font_size, color) };
}
...
pub fn image_draw_text_ex(
    ...
    unsafe { rl::ImageDrawTextEx(dst, font, text, position, font_size, spacing, tint) };
}

/** Load texture from file into GPU memory (VRAM) */
pub fn load_texture(file_name: *const c_char) -> Texture2D {
    return unsafe { rl::LoadTexture(file_name) };
}
...
pub fn draw_texture_quad(
    ...
    unsafe { rl::DrawTextureQuad(texture, tiling, offset, quad, tint) };
}
...
pub fn draw_texture_tiled(
    ...
    unsafe { rl::DrawTextureTiled(texture, source, dest, origin, rotation, scale, tint) };
}
...
pub fn draw_texture_poly(
    ...
    unsafe { rl::DrawTexturePoly(texture, center, points, texcoords, point_count, tint) };
}
...
pub fn load_font(file_name: *const c_char) -> Font {
    return unsafe { rl::LoadFont(file_name) };
}
...
pub fn load_font_ex(
    file_name: *const c_char,
    font_size: c_int,
    font_chars: *mut c_int,
    glyph_count: c_int,
) -> Font {
    return unsafe { rl::LoadFontEx(file_name, font_size, font_chars, glyph_count) };
}
...
pub fn gen_image_font_atlas(
    ...
    return unsafe {
        rl::GenImageFontAtlas(chars, recs, glyph_count, font_size, padding, pack_method)
    };
}

/** Unload font chars info data (RAM) */
pub fn unload_font_data(chars: *mut GlyphInfo, glyph_count: c_int) {
    unsafe { rl::UnloadFontData(chars, glyph_count) };
}
...
pub fn export_font_as_code(font: Font, file_name: *const c_char) -> bool {
    return unsafe { rl::ExportFontAsCode(font, file_name) };
}
...
pub fn draw_text(text: *const c_char, pos_x: c_int, pos_y: c_int, font_size: c_int, color: Color) {
    unsafe { rl::DrawText(text, pos_x, pos_y, font_size, color) };
}
...
pub fn draw_text_ex(
    ...
    unsafe { rl::DrawTextEx(font, text, position, font_size, spacing, tint) };
}
...
pub fn draw_text_codepoints(
    ...
    unsafe { rl::DrawTextCodepoints(font, codepoints, count, position, font_size, spacing, tint) };
}

/** Measure string width for default font */
pub fn measure_text(text: *const c_char, font_size: c_int) -> c_int {
    return unsafe { rl::MeasureText(text, font_size) };
}

/** Measure string size for Font */
pub fn measure_text_ex(font: Font, text: *const c_char, font_size: f32, spacing: f32) -> Vector2 {
    return unsafe { rl::MeasureTextEx(font, text, font_size, spacing) };
}
...
pub fn load_codepoints(text: *const c_char, count: *mut c_int) -> *mut c_int {
    return unsafe { rl::LoadCodepoints(text, count) };
}
...
pub fn get_codepoint_count(text: *const c_char) -> c_int {
    return unsafe { rl::GetCodepointCount(text) };
}

/** Get next codepoint in a UTF-8 encoded string, 0x3f('?') is returned on failure */
pub fn get_codepoint(text: *const c_char, bytes_processed: *mut c_int) -> c_int {
    return unsafe { rl::GetCodepoint(text, bytes_processed) };
}

/** Encode one codepoint into UTF-8 byte array (array length returned as parameter) */
pub fn codepoint_to_utf_8(codepoint: c_int, byte_size: *mut c_int) -> *const c_char {
    return unsafe { rl::CodepointToUTF8(codepoint, byte_size) };
}

/** Encode text as codepoints array into UTF-8 text string (WARNING: memory must be freed!) */
pub fn text_codepoints_to_utf_8(codepoints: *const c_int, length: c_int) -> *mut c_char {
    return unsafe { rl::TextCodepointsToUTF8(codepoints, length) };
}

/** Copy one string to another, returns bytes copied */
pub fn text_copy(dst: *mut c_char, src: *const c_char) -> c_int {
    return unsafe { rl::TextCopy(dst, src) };
}

/** Check if two text string are equal */
pub fn text_is_equal(text_1: *const c_char, text_2: *const c_char) -> bool {
    return unsafe { rl::TextIsEqual(text_1, text_2) };
}

/** Get text length, checks for '\0' ending */
pub fn text_length(text: *const c_char) -> c_uint {
    return unsafe { rl::TextLength(text) };
}

/** Text formatting with variables (sprintf() style) */
pub fn text_format(text: *const c_char) -> *const c_char {
    return unsafe { rl::TextFormat(text) };
}

/** Get a piece of a text string */
pub fn text_subtext(text: *const c_char, position: c_int, length: c_int) -> *const c_char {
    return unsafe { rl::TextSubtext(text, position, length) };
}

/** Replace text string (WARNING: memory must be freed!) */
pub fn text_replace(text: *mut c_char, replace: *const c_char, by: *const c_char) -> *mut c_char {
    return unsafe { rl::TextReplace(text, replace, by) };
}

/** Insert text in a position (WARNING: memory must be freed!) */
pub fn text_insert(text: *const c_char, insert: *const c_char, position: c_int) -> *mut c_char {
    return unsafe { rl::TextInsert(text, insert, position) };
}

/** Join text strings with delimiter */
pub fn text_join(
    text_list: *mut *const c_char,
    count: c_int,
    delimiter: *const c_char,
) -> *const c_char {
    return unsafe { rl::TextJoin(text_list, count, delimiter) };
}

/** Split text into multiple strings */
pub fn text_split(text: *const c_char, delimiter: c_char, count: *mut c_int) -> *mut *const c_char {
    return unsafe { rl::TextSplit(text, delimiter, count) };
}

/** Append text at specific position and move cursor! */
pub fn text_append(text: *mut c_char, append: *const c_char, position: *mut c_int) {
    unsafe { rl::TextAppend(text, append, position) };
}

/** Find first text occurrence within a string */
pub fn text_find_index(text: *const c_char, find: *const c_char) -> c_int {
    return unsafe { rl::TextFindIndex(text, find) };
}

/** Get upper case version of provided string */
pub fn text_to_upper(text: *const c_char) -> *const c_char {
    return unsafe { rl::TextToUpper(text) };
}

/** Get lower case version of provided string */
pub fn text_to_lower(text: *const c_char) -> *const c_char {
    return unsafe { rl::TextToLower(text) };
}

/** Get Pascal case notation version of provided string */
pub fn text_to_pascal(text: *const c_char) -> *const c_char {
    return unsafe { rl::TextToPascal(text) };
}

/** Get integer value from text (negative values not supported) */
pub fn text_to_integer(text: *const c_char) -> c_int {
    return unsafe { rl::TextToInteger(text) };
}
...
pub fn draw_cube_texture(
    ...
    unsafe { rl::DrawCubeTexture(texture, position, width, height, length, color) };
}

/** Draw cube with a region of a texture */
pub fn draw_cube_texture_rec(
    texture: Texture2D,
    source: Rectangle,
    position: Vector3,
    width: f32,
    ...
    unsafe { rl::DrawCubeTextureRec(texture, source, position, width, height, length, color) };
}
...
pub fn load_model(file_name: *const c_char) -> Model {
    return unsafe { rl::LoadModel(file_name) };
}
...
pub fn unload_model_keep_meshes(model: Model) {
    unsafe { rl::UnloadModelKeepMeshes(model) };
}
...
pub fn export_mesh(mesh: Mesh, file_name: *const c_char) -> bool {
    return unsafe { rl::ExportMesh(mesh, file_name) };
}
...
pub fn load_materials(file_name: *const c_char, material_count: *mut c_int) -> *mut Material {
    return unsafe { rl::LoadMaterials(file_name, material_count) };
}
...
pub fn load_model_animations(
    file_name: *const c_char,
    anim_count: *mut c_uint,
) -> *mut ModelAnimation {
    return unsafe { rl::LoadModelAnimations(file_name, anim_count) };
}
...
pub fn unload_model_animations(animations: *mut ModelAnimation, count: c_uint) {
    unsafe { rl::UnloadModelAnimations(animations, count) };
}
...
pub fn load_wave(file_name: *const c_char) -> Wave {
    return unsafe { rl::LoadWave(file_name) };
}
...
pub fn load_wave_from_memory(
    ...
    return unsafe { rl::LoadWaveFromMemory(file_type, file_data, data_size) };
}

/** Load sound from file */
pub fn load_sound(file_name: *const c_char) -> Sound {
    return unsafe { rl::LoadSound(file_name) };
}
...
pub fn export_wave(wave: Wave, file_name: *const c_char) -> bool {
    return unsafe { rl::ExportWave(wave, file_name) };
}

/** Export wave sample data to code (.h), returns true on success */
pub fn export_wave_as_code(wave: Wave, file_name: *const c_char) -> bool {
    return unsafe { rl::ExportWaveAsCode(wave, file_name) };
}
...
pub fn play_sound_multi(sound: Sound) {
    unsafe { rl::PlaySoundMulti(sound) };
}

/** Stop any sound playing (using multichannel buffer pool) */
pub fn stop_sound_multi() {
    unsafe { rl::StopSoundMulti() };
}

/** Get number of sounds playing in the multichannel */
pub fn get_sounds_playing() -> c_int {
    return unsafe { rl::GetSoundsPlaying() };
}
...
pub fn load_music_stream(file_name: *const c_char) -> Music {
    return unsafe { rl::LoadMusicStream(file_name) };
}
...
pub fn load_music_stream_from_memory(
    ...
    return unsafe { rl::LoadMusicStreamFromMemory(file_type, data, data_size) };
}
