...
pub fn load_file_data(file_name: *const c_char, data_size: *mut c_int) -> *mut c_uchar {
    return unsafe { rl::LoadFileData(file_name, data_size) };
}
...
pub fn save_file_data(file_name: *const c_char, data: *mut c_void, data_size: c_int) -> bool {
    return unsafe { rl::SaveFileData(file_name, data, data_size) };
}
...
pub fn export_data_as_code(
    ...
    return unsafe { rl::ExportDataAsCode(data, data_size, file_name) };
}
...
pub fn load_automation_event_list(file_name: *const c_char) -> AutomationEventList {
    return unsafe { rl::LoadAutomationEventList(file_name) };
}
...
pub fn export_automation_event_list(list: AutomationEventList, file_name: *const c_char) -> bool {
    return unsafe { rl::ExportAutomationEventList(list, file_name) };
}
...
pub fn load_image_svg(file_name_or_string: *const c_char, width: c_int, height: c_int) -> Image {
    return unsafe { rl::LoadImageSvg(file_name_or_string, width, height) };
}
...
pub fn export_image_to_memory(
    ...
    return unsafe { rl::ExportImageToMemory(image, file_type, file_size) };
}
...
pub fn gen_image_text(width: c_int, height: c_int, text: *const c_char) -> Image {
    return unsafe { rl::GenImageText(width, height, text) };
}
...
pub fn load_font_ex(
    ...
    return unsafe { rl::LoadFontEx(file_name, font_size, codepoints, codepoint_count) };
}
...
pub fn get_codepoint(text: *const c_char, codepoint_size: *mut c_int) -> c_int {
    return unsafe { rl::GetCodepoint(text, codepoint_size) };
}

/** Get next codepoint in a UTF-8 encoded string, 0x3f('?') is returned on failure */
pub fn get_codepoint_next(text: *const c_char, codepoint_size: *mut c_int) -> c_int {
    return unsafe { rl::GetCodepointNext(text, codepoint_size) };
}

/** Get previous codepoint in a UTF-8 encoded string, 0x3f('?') is returned on failure */
pub fn get_codepoint_previous(text: *const c_char, codepoint_size: *mut c_int) -> c_int {
    return unsafe { rl::GetCodepointPrevious(text, codepoint_size) };
}
